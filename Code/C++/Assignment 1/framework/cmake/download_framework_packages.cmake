if (PACKAGE_MANAGER STREQUAL "FetchContent")
	...
	FetchContent_Declare(fmt
		...
		GIT_SHALLOW TRUE)
	FetchContent_MakeAvailable(glfw glad glm msgsl fmt)
...
elseif ((PACKAGE_MANAGER STREQUAL "vcpkg") OR (PACKAGE_MANAGER STREQUAL "system"))
	...
	set(FRAMEWORK_GRAPHICS_TARGETS glfw glad::glad imgui::imgui glm)
	set(FRAMEWORK_NON_GRAPHICS_TARGETS Microsoft.GSL::GSL fmt::fmt)
elseif (PACKAGE_MANAGER STREQUAL "conan")
	include("cmake/conan.cmake")
	conan_cmake_run(
		REQUIRES "glfw/3.3.2" "glad/0.1.33" "glm/0.9.9.8" "ms-gsl/3.1.0" "imgui/1.77" "fmt/7.0.3"
		BASIC_SETUP CMAKE_TARGETS
		BUILD missing)

	set(FRAMEWORK_GRAPHICS_TARGETS CONAN_PKG::glfw CONAN_PKG::glad CONAN_PKG::imgui CONAN_PKG::glm)
